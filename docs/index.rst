...
as Github_, Gitter_ and `Julia Discourse`_. And of coursee we like to invite more users and grow
...
We'll feature this at the Contibuted section of different Julia's data query packages, namely the DataFramesMeta.jl_ and the Query.jl_.
